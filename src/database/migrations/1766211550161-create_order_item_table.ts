...
export class CreateOrderItemTable1766211550161 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_1afe31fc27838ad670e3a280cf" ON "orders" ("buyer_phone_number") `);
        await queryRunner.query(`CREATE INDEX "IDX_abbd6441ce2aecb38da2f80b46" ON "orders" ("buyer_email") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_6335813ef19bc35b8d866cc656" ON "order_items" ("order_id", "product_id") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_6335813ef19bc35b8d866cc656"`);
        await queryRunner.query(`DROP TABLE "order_items"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_75eba1c6b1a66b09f2a97e6927"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_abbd6441ce2aecb38da2f80b46"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_1afe31fc27838ad670e3a280cf"`);
