...
export class UserStorePermission extends BaseEntity {
  @ManyToOne(() => UserStore, (userStore) => userStore.userStorePermissions, { onDelete: 'CASCADE' })
  @JoinColumn({ name: 'user_store_id' })
  userStore: UserStore;

  @ManyToOne(() => Permission, (permission) => permission.userStorePermissions, { onDelete: 'CASCADE' })
